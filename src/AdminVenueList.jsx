...
const AdminVenueList = () => {
  const venues = [
    { id: 1, name: 'Grand Ballroom', location: 'Downtown, NY', capacity: 500, status: 'Active' },
    { id: 2, name: 'Ocean View Terrace', location: 'Coastal City, CA', capacity: 200, status: 'Active' },
    { id: 3, name: 'Mountain Lodge', location: 'Mountain Town, CO', capacity: 150, status: 'Inactive' },
    { id: 4, name: 'City Center Hall', location: 'Metropolis, IL', capacity: 300, status: 'Active' },
    { id: 5, name: 'Lakeside Pavilion', location: 'Lakefront, MI', capacity: 250, status: 'Inactive' },
  ];
