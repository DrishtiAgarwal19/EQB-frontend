...
const Dashboard = () => {
  return (
    <div className="flex h-screen bg-gray-100">
      {/* Sidebar */}
      <div className="w-full md:w-64 bg-gray-200 p-4 flex flex-col">
        <h2 className="text-xl sm:text-2xl font-semibold mb-4">VenueFinder</h2>
        <nav className="flex-grow">
          <ul className="space-y-2">
            <li>
              <Link to="/dashboard" className="flex items-center py-2 px-4 bg-gray-300 rounded text-sm sm:text-base">
            ...
            <li>
              <Link to="/my-bookings" className="flex items-center py-2 px-4 hover:bg-gray-300 rounded text-sm sm:text-base">
                <svg className="h-4 w-4 sm:h-5 sm:w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                My Bookings
              </Link>
            </li>
            <li>
              <Link to="/wishlist" className="flex items-center py-2 px-4 hover:bg-gray-300 rounded text-sm sm:text-base">
        ...
        <Link to="/logout" className="flex items-center py-2 px-4 hover:bg-gray-300 rounded mt-4 text-sm sm:text-base">
          <svg className="h-4 w-4 sm:h-5 sm:w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path></svg>
          Logout
        </Link>
      </div>
      ...
      <div className="flex-1 p-4 sm:p-8">
        ...
        {/* Wishlist Section */}
        <div className="mt-8">
          <h2 className="text-xl sm:text-2xl font-semibold mb-4">Wishlist</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white rounded-md shadow-lg p-4">
              <img src="https://via.placeholder.com/300x150" alt="Wishlist Item" className="mb-2 w-full h-auto" />
              <p className="text-sm sm:text-base">The Coastal Retreat</p>
            </div>
            <div className="bg-white rounded-md shadow-lg p-4">
              <img src="https://via.placeholder.com/300x150" alt="Wishlist Item" className="mb-2 w-full h-auto" />
              <p className="text-sm sm:text-base">The Mountain Lodge</p>
            </div>
          </div>
        </div>
      </div>
