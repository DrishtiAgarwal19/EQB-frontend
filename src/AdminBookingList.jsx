...
const AdminBookingList = () => {
  const bookings = [
    { id: 'BK12345', venue: 'The Grand Ballroom', date: '2024-08-15', client: 'Emily Carter', status: 'Confirmed' },
    { id: 'BK12346', venue: 'The Lakeside Pavilion', date: '2024-08-20', client: 'David Lee', status: 'Pending' },
    { id: 'BK12347', venue: 'The City View Loft', date: '2024-08-22', client: 'Sophia Clark', status: 'Confirmed' },
    { id: 'BK12348', venue: 'The Garden Terrace', date: '2024-08-25', client: 'Ethan Walker', status: 'Cancelled' },
    { id: 'BK12349', venue: 'The Grand Ballroom', date: '2024-08-28', client: 'Olivia Harris', status: 'Confirmed' },
    { id: 'BK12350', venue: 'The Lakeside Pavilion', date: '2024-09-01', client: 'Noah Turner', status: 'Pending' },
    { id: 'BK12351', venue: 'The City View Loft', date: '2024-09-05', client: 'Ava Bennett', status: 'Confirmed' },
    { id: 'BK12352', venue: 'The Garden Terrace', date: '2024-09-10', client: 'Liam Foster', status: 'Cancelled' },
    { id: 'BK12353', venue: 'The Grand Ballroom', date: '2024-09-15', client: 'Isabella Reed', status: 'Confirmed' },
    { id: 'BK12354', venue: 'The Lakeside Pavilion', date: '2024-09-20', client: 'Jackson Cole', status: 'Pending' },
  ];
    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-white shadow-md p-6 flex flex-col">
        ...
        <nav className="space-y-4">
          ...
          <Link to="/admin/bookings" className="flex items-center p-3 rounded-lg bg-gray-200 text-blue-700 font-semibold hover:bg-gray-300">
